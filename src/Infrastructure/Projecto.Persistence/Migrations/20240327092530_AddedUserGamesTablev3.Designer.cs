...
namespace Projecto.Persistence.Migrations
{
    ...
    [Migration("20240327092530_AddedUserGamesTablev3")]
    partial class AddedUserGamesTablev3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Projecto.Persistence.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Projecto.Persistence.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Projecto.Domain.Models.UserGame", b =>
                {
                    ...
                    b.HasOne("Projecto.Persistence.Models.AppUser", "User")
                        .WithMany("UserGames")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
